...
class TestCndDiffPointColors:
    ...
    def test_perm_alternates_by_position_across_one_cluster(self):
        ...
        colors = cnd_diff_point_colors(
            "a", "b", sig_mask, "perm", n_timepoints=8, cnds=["a", "b"], colors=["red", "green"]
        )

        np.testing.assert_array_equal(colors[2:6], ["red", "green", "red", "green"])
    ...
    def test_perm_alternation_continues_across_multiple_clusters(self):
        ...
        colors = cnd_diff_point_colors(
            "a", "b", sig_mask, "perm", n_timepoints=9, cnds=["a", "b"], colors=["red", "green"]
        )
    ...
    def test_ttest_boolean_mask_alternates_by_position(self):
        ...
        colors = cnd_diff_point_colors(
            "a", "b", sig_mask, "ttest", n_timepoints=5, cnds=["a", "b"], colors=["red", "green"]
        )
    ...
    def test_no_significant_points_returns_all_first_color(self):
        ...
        colors = cnd_diff_point_colors(
            "a", "b", sig_mask, "perm", n_timepoints=4, cnds=["a", "b"], colors=["red", "green"]
        )
    ...
    def test_cnds_none_returns_none(self):
        assert (
            cnd_diff_point_colors("a", "b", [], "perm", 4, cnds=None, colors=["red", "green"])
            is None
        )

    @pytest.mark.unit
    def test_colors_none_returns_none(self):
        assert cnd_diff_point_colors("a", "b", [], "perm", 4, cnds=["a", "b"], colors=None) is None

    @pytest.mark.unit
    def test_condition_not_in_cnds_returns_none(self):
        assert (
            cnd_diff_point_colors("a", "c", [], "perm", 4, cnds=["a", "b"], colors=["red", "green"])
            is None
        )
    ...
    def test_color_index_out_of_range_returns_none(self):
        ...
        assert (
            cnd_diff_point_colors(
                "a", "c", [], "perm", 4, cnds=["a", "b", "c"], colors=["red", "green"]
            )
            is None
        )
